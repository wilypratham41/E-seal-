...
public class GenerateEsealActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_generate_eseal);
        ...
        generateQRBtn.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                if (TextUtils.isEmpty(dataEdt.getText().toString())) {
                    ...
                    Toast.makeText(GenerateEsealActivity.this, "Enter some text to generate QR Code", Toast.LENGTH_SHORT).show();
                } else {
